...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                cellPose = position; //запись позиции нажатия на элемент
    ...
    public void on_edit_click(View view){
        ...
        i.putExtra("my-note-index", cellPose/*передача индакса выбранного элемента*/); //share note data with new activity
        i.putExtra("my-note-title", adp.getItem(cellPose).title);
        i.putExtra("my-note-content", adp.getItem(cellPose).content);
        ...
        builder.setTitle("Are you sure you want to delete the note?")
                .setPositiveButton("ОК", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        adp.remove(adp.getItem(cellPose));
                        adp.notifyDataSetChanged(); //update list box
                        dialog.cancel();
                    }
                })
